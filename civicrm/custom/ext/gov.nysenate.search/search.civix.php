 ...
 * extension.
 */
class CRM_NYSS_Search_ExtensionUtil {
  const SHORT_NAME = 'search';
  const LONG_NAME = 'gov.nysenate.search';
  const CLASS_PREFIX = 'CRM_NYSS_Search';
...
/**
 * @return CRM_NYSS_Search_Upgrader
 */
function _search_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/NYSS/Search/Upgrader.php')) {
    return NULL;
  }
  else {
    return CRM_NYSS_Search_Upgrader_Base::instance();
  }
}
