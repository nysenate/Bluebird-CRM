...
CREATE FUNCTION BB_NORMALIZE (value VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci)
    RETURNS VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DETERMINISTIC
...
CREATE FUNCTION BB_NORMALIZE_ADDR (value VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci)
    RETURNS VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DETERMINISTIC
