 ...
 */
class CRM_NYSS_Contact_Upgrader_Base {

  /**
   * @var CRM_NYSS_Contact_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_NYSS_Contact_Upgrader(
        'gov.nysenate.contact',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_NYSS_Contact_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_NYSS_Contact_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
