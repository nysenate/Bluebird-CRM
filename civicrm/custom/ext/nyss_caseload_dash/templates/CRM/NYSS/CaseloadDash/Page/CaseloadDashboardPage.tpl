...
<div class="section nyss-caseload-dash-intro-section">
    ...
    <div class="content">{ts}A real-time snapshot of your district's caseload health. At a glance, track case aging, monitor workload, and ensure every case is being attended to.{/ts} {help id="id-dashboard_intro" title="{ts}Caseload Dashboard{/ts}"}</div>
    <div class="clear"></div>
</div>
