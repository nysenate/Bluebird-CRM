<div id="bootstrap-theme" class="nyss-caseload-dash">
    <div class="section nyss-caseload-dash-intro-section">
        <h2><i class="crm-i fa-tachometer" role="img" aria-hidden="true"></i> {ts}Welcome to Your District's Caseload Dashboard{/ts}</h2>
        <div class="content">{ts}A real-time snapshot of your district's caseload health.{/ts} {help id="id-dashboard_intro" title="{ts}Caseload Dashboard{/ts}"}</div>
        <div class="clear"></div>
    </div>
