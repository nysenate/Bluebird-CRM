...
(civicrm/admin/options/site_email_address?reset=1), and at Administer > CiviMail >
From Email Addresses (civicrm/admin/options/site_email_address?reset=1).
