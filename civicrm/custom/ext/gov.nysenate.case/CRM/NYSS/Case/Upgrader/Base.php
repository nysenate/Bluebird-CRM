 ...
 */
class CRM_NYSS_Case_Upgrader_Base {

  /**
   * @var CRM_NYSS_Case_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_NYSS_Case_Upgrader(
        'gov.nysenate.case',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_NYSS_Case_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_NYSS_Case_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
