...
WHERE      a.id = %1 
    ...
    function &getActivity( $clientID,
		...
		//NYSS 3078 need to strip html before printing
		$details_redacted = $this->redact(CRM_Utils_String::stripAlternatives($activityDAO->details));
		$details_cleaned = CRM_Utils_String::htmlToText( $details_redacted );
        $activity['fields'][] = array( 'label' => 'Details',
                                       'value' => $details_cleaned,
                                       'type'  => 'Memo' );
