...
class CRM_Case_BAO_Query extends CRM_Core_BAO_Query {
  ...
  public static function select(&$query) {
    ...
    //NYSS 9018
    if (CRM_Utils_Array::value('case_activity_id', $query->_returnProperties)) {
      $query->_select['case_activity_id'] = "case_activity.id as case_activity_id";
      $query->_element['case_activity_id'] = 1;
      $query->_tables['case_activity'] = 1;
      $query->_tables['civicrm_case_contact'] = 1;
      $query->_tables['civicrm_case'] = 1;
    }
