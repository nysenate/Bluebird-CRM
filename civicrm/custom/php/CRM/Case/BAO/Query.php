...
class CRM_Case_BAO_Query 
{
    ...
    static function whereClauseSingle( &$values, &$query ) 
    {
		...
		case 'case_tags':
        	...
        	$tags = CRM_Core_PseudoConstant::tag( ); //NYSS 3426
            ...
            $query->_tables['civicrm_case']  = $query->_whereTables['civicrm_case']  = 1; //NYSS
 	 	    $query->_tables['civicrm_case_contact'] = $query->_whereTables['civicrm_case_contact'] = 1; //NYSS
