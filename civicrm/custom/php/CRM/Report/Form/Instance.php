...
class CRM_Report_Form_Instance {
  ...
  <body><div id=\"crm-container\">";
        ...
        $defaults['report_footer'] = $report_footer = "</div></body></html>"; //NYSS remove powered by image
    ...
    static function postProcess( &$form ) {
        ...
        if ( $dao->id ) {
            ...
            if ( !empty( $dashletParams ) ) {
                ...
                $dashletParams['url'           ] = "civicrm/report/instance/{$dao->id}&reset=1&section={$section}&snippet=4{$chart}&context=dashlet"; //NYSS 3983
