    ...
    function from( ) {
		...
		if ( $this->_phoneField ) {
            ...
            LEFT JOIN civicrm_phone civicrm_phone_target 
                   ON {$this->_aliases['civicrm_activity_target']}.target_contact_id = civicrm_phone_target.contact_id AND 
                      civicrm_phone_target.is_primary = 1

            LEFT JOIN civicrm_phone civicrm_phone_assignee 
                   ON {$this->_aliases['civicrm_activity_assignment']}.assignee_contact_id = civicrm_phone_assignee.contact_id AND 
