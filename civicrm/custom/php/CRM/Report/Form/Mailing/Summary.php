...
class CRM_Report_Form_Mailing_Summary extends CRM_Report_Form {
  ...
  public function __construct() {
    ...
    $this->_columns['civicrm_mailing_job'] = array(
      ...
      'fields' => array(
        'start_date' => array(
          'title' => ts('Start Date'),
          'dbAlias' => 'MIN(mailing_job_civireport.start_date)',//NYSS 11356
        ),
        'end_date' => array(
          'title' => ts('End Date'),
          'dbAlias' => 'MAX(mailing_job_civireport.end_date)',//NYSS 11356
        ),
      ),
      'filters' => array(
        'status' => array(
  ...
  public static function getChartCriteria() {
    return array(
      ...
      'rate' => array(
        'civicrm_mailing_event_sendgrid_delivered_accepted_rate' => ts('Accepted Rate'), //NYSS
