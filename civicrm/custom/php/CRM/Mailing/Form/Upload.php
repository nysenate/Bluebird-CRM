...
class CRM_Mailing_Form_Upload extends CRM_Core_Form 
{
    ...
    public function buildQuickForm( ) 
    {
        ...
        $this->add( 'select', 'header_id', ts( 'Mailing Header' ), 
                    /*array('' => ts('- none -')) +*/ CRM_Mailing_PseudoConstant::component( 'Header' ) ); //NYSS 2812 enforce default value
        
        $this->add( 'select', 'footer_id', ts( 'Mailing Footer' ), 
                    /*array('' => ts('- none -')) +*/ CRM_Mailing_PseudoConstant::component( 'Footer' ) ); //NYSS
