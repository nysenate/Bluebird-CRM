...
class CRM_Import_Form_DataSource extends CRM_Core_Form {
    ...
    public function buildQuickForm( ) {
        ...
        //$this->setDefaults(array('dataSource' => 'CRM_Import_DataSource_CSV')); //NYSS 3750
		...
		$js = array('onClick' => "buildSubTypes();buildDedupeRules();"); //NYSS
		...
		$this->addElement( 'select', 'dedupe' , ts( 'Dedupe Rule' ) ); //NYSS
		...
		$this->addElement('text','fieldSeparator', ts('Import Field Separator'), array('size' => 2)); //NYSS
