...
class CRM_Dedupe_BAO_Rule extends CRM_Dedupe_DAO_Rule
{
    ...
    function sql() {
        ...
        case 'civicrm_contact':
            $id = 'id';
			//NYSS we should restrict by contact type in the first step
			$sql_ct = "SELECT contact_type FROM civicrm_dedupe_rule_group WHERE id = {$this->dedupe_rule_group_id};";
			$ct = CRM_Core_DAO::singleValueQuery( $sql_ct );
			if ($this->params) {
