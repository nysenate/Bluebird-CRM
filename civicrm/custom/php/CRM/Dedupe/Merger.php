...
INNER JOIN  civicrm_membership membership2 ON membership1.membership_type_id = membership2.membership_type_id
  ...
  public static function createMergeActivities($mainId, $otherId) {
    ...
    if (civicrm_api3('Setting', 'getvalue', [
      ...
      //NYSS this is failing to do an activity type lookup by name; lookup and set with ID
      $activityTypeId = CRM_Core_DAO::singleValueQuery("SELECT value FROM civicrm_option_value WHERE name LIKE 'Contact Deleted by Merge'");
