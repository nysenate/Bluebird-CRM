...
INNER JOIN  civicrm_membership membership2 ON membership1.membership_type_id = membership2.membership_type_id
    ...
    function findDifferences($mainId, $otherId)
    {
        ...
        unset($main, $other, $mainEvs, $otherEvs); //NYSS
        return $diffs;
    }
    ...
    function batchMerge( $rgid, $gid = null, $mode = 'safe', $autoFlip = true, $redirectForPerformance = false ) //NYSS
    {
        ...
        $limit = $redirectForPerformance ? 50 : 1; //NYSS
    ...
    function merge( $dupePairs = array(), $cacheParams = array(), $mode = 'safe', 
        ...
        while ( !empty($dupePairs) ) {
            foreach ( $dupePairs as $dupes ) {
                ...
                $rowsElementsAndInfo =& CRM_Dedupe_Merger::getRowsElementsAndInfo( $mainId, $otherId ); //NYSS
    ...
    function moveAllBelongings( $mainId, $otherId, $migrationInfo )
    {
        ...
        if ( !empty( $moveTables ) ) {
            ...
            unset( $moveTables, $tableOperations ); //NYSS
        }
