...
class CRM_Contact_Page_View_Summary extends CRM_Contact_Page_View
{
  ...
  public function preProcess()
  {
    ...
    CRM_Core_BAO_CustomGroup::buildCustomDataView($this, $groupTree, false,
                                                  null, null, null,
                                                  $this->_contactId);

    // also create the form element for the activity links box
    $controller = new CRM_Core_Controller_Simple(
      'CRM_Activity_Form_ActivityLinks', ts('Activity Links'),
  ...
  public function view()
  {
    ...
    // FIXME: when we sort out TZ isssues with DATETIME/TIMESTAMP, we can
    // skip next query; also assign the last modifed details
      ...
      elseif ($accessCiviCRM && !empty($this->_viewOptions[$tab['id']])) {
        ...
        $allTabs[] = $tab + [
          'url' => CRM_Utils_System::url(
            ...
            "reset=1&cid={$this->_contactId}{$crmPID}"//NYSS
          ),
