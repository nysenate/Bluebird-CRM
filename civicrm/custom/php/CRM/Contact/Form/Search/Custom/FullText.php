...
";
    ...
    $this->_entityIDTableNameSort = "{$this->_entityIDTableName}_s";
    $final[] = "CREATE TABLE {$this->_entityIDTableNameSort} LIKE {$this->_entityIDTableName}";
    $final[] = "INSERT INTO {$this->_entityIDTableNameSort}
      SELECT t1.*
      FROM {$this->_entityIDTableName} t1
      JOIN civicrm_contact c
        ON t1.entity_id = c.id
      ORDER BY c.sort_name";
    $final[] = "DROP TABLE {$this->_entityIDTableName}";
    $final[] = "RENAME TABLE {$this->_entityIDTableNameSort} TO {$this->_entityIDTableName}";
