...
class CRM_Contact_Form_Task_Label extends CRM_Contact_Form_Task {
  ...
  public function postProcess($params = NULL) {
    ...
    //NYSS 14192
    if (empty($fv['include_title_org'])) {
      $mailingFormat = str_replace('{contact.current_employer}', '', $mailingFormat);
      $mailingFormat = str_replace('{contact.job_title}', '', $mailingFormat);
    }
