...
class CRM_Contact_Form_Task_RemoveFromTag extends CRM_Contact_Form_Task {
    ...
    function buildQuickForm( ) {
        ...
        CRM_Core_Form_Tag::buildQuickForm( $this, $parentNames, 'civicrm_contact', null, true, false, true ); //NYSS
    ...
    static function formRule( $form, $rule) {
        $errors = array( );
        if ( empty( $form['tag'] ) && empty( $form['contact_taglist'] ) ) { //NYSS
            $errors['_qf_default'] = "Please select at least one tag.";
        }
        return $errors;
    }
    /**
