    ...
    public function postProcess() {
        ...
        if ( ! $this->_single ) {
            ...
            if ( $deletedContacts ) {
				...
				//NYSS let's return to the contact -- even if deleted
				$returnToContact = 1;
		...
		if ( $returnToContact == 0 ) $session->replaceUserContext( CRM_Utils_System::url( $urlString, $urlParams ) ); //NYSS
    }//end of function
}
