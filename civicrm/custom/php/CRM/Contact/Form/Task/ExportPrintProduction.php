...
class CRM_Contact_Form_Task_ExportPrintProduction extends CRM_Contact_Form_Task {
    ...
    public function postProcess() {
        ...
        $sql = "CREATE TEMPORARY TABLE tmpExport{$rnd}_IDs 
        ...
        $sql   = "CREATE TABLE tmpExport$rnd  
                  ( $cFlds, 
...
function getColumns( $output = 'select' ) {
    ...
    $fields = array( 
        ...
        'ch.addressee_display'                   => array( 'alias' => 'household_addressee_display',
                                                           'def'   => 'varchar(255)' ),
        'LPAD(congressional_district_46,2,\'0\')'=> array( 'alias' => 'congressional_district_46',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(ny_senate_district_47,2,\'0\')'    => array( 'alias' => 'ny_senate_district_47',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(ny_assembly_district_48,3,\'0\')'  => array( 'alias' => 'ny_assembly_district_48',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(election_district_49,3,\'0\')'     => array( 'alias' => 'election_district_49',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(county_50,2,\'0\')'                => array( 'alias' => 'county_50',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(county_legislative_district_51,2,\'0\')' => array( 'alias' => 'county_legislative_district_51',
                                                           'def'   => 'varchar(64)' ),
        'town_52'                                => array( 'alias' => 'town_52',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(ward_53,2,\'0\')'                  => array( 'alias' => 'ward_53',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(school_district_54,3,\'0\')'       => array( 'alias' => 'school_district_54',
                                                           'def'   => 'varchar(64)' ),
        'LPAD(new_york_city_council_55,2,\'0\')' => array( 'alias' => 'new_york_city_council_55',
                                                           'def'   => 'varchar(64)' ),
