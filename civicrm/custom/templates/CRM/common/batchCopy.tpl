...
function copyValues(fieldName, source)
{
    ...
    if ( document.getElementById(source) ) {
        ...
        //NYSS 4689
		} else if ( document.getElementsByName("field"+"["+cId[0]+"]"+"["+fieldName+"]")[1].type == "checkbox" ) {
            for ( k=0; k<cId.length; k++ ) {
                document.getElementsByName("field"+"["+cId[k]+"]"+"["+fieldName+"]")[1].checked = document.getElementsByName("field"+"["+cId[0]+"]"+"["+fieldName+"]")[1].checked;
            }
