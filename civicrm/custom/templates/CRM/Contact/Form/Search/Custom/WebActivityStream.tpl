...
<div class="help">Use this tool to search contact website activity records.</div>
    ...
    <div class="crm-accordion-body" id="BirthdayByMonth">
      ...
      <table class="form-layout-compressed">
        <tr class="crm-contact-custom-search-form-row-altered_by">
          <td class="label"><label for="altered_by">{$form.sort_name.label}</label></td>
          <td>{$form.sort_name.html}</td>
        </tr>
        <tr class="crm-contact-custom-search-form-row-search-type">
          <td class="label"><label for="search_type">{$form.type.label}</label></td>
