  ...
  <div class="crm-accordion-wrapper crm-search_filters-accordion">
    ...
    <div class="crm-accordion-body">
      <div class="no-border form-layout-compressed activity-search-options">
        ...
        {*NYSS - activities for past x days filter*}
        <div id="contact-activity-selector-dashlet_pastDays" class="crm-inline-edit-field">
          Show activities for past
          <select id='past_days' class="crm-form-select">
            <option value='all' selected="selected"> - All - </option>
            <option value='7'>7</option>
            <option value='14'>14</option>
            <option value='30'>30</option>
          </select> days, and for
          <select id="status_id" class="crm-form-select">
            <option value="all" selected="selected"> - All - </option>
        ...
        CRM.$('table.contact-activity-selector-' + context).data({
          "ajax": {
            ...
            "data": function (d) {
              ...
              d.past_days = $('.crm-activity-selector-activity select#past_days').val(),
              d.status_id = $('.crm-activity-selector-activity select#status_id').val()
            }
          }
        });
        $(function($) {
