	...
	{if call_user_func(array('CRM_Core_Permission','giveMeAllACLs'))}
		<form id="id_search_block" name="Custom" method="post" action="{crmURL p='civicrm/contact/search/custom' h=0 }">
           	<div class="input-wrapper" id="gen-search-wrapper">
				...
				<input type="submit" value="Go" name="_qf_Custom_refresh" class="form-submit default" style="background-image:url(/sites/default/themes/rayCivicrm/nyss_skin/images/t.gif)"> 
			</div>
		</form>
...
cj( document ).ready( function( ) {
   var htmlContent = '';
      htmlContent = '<input type="hidden" name="_qf_Basic_refresh">' +
					...
					'<input type="submit" id="find_contacts" value="Go" name="_qf_Basic_refresh" class="form-submit default" style="background-image:url(/sites/default/themes/rayCivicrm/nyss_skin/images/t.gif)" />';
