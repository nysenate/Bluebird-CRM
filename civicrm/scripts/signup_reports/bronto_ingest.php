...
function save_record($record, $list, $conn) {
    ...
    $sql = "
        INSERT INTO person
            (first_name, last_name, address1, address2, city, state, zip, phone, email, status, created, modified, bronto)
        VALUES
            ('$first_name', '$last_name', '$address1', '$address2', '$city', '$state', '$zip', '$phone', '$email', '$status', '$dt_created', '$dt_modified', 1)";
