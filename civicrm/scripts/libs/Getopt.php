...
//NYSS 12917 - php inexplicably throws a "cannot declare class... name already in use" error
//here, even though we are using require_once. see:
//https://stackoverflow.com/questions/58189978/cannot-declare-class-because-the-name-is-already-in-use-even-when-using-require
//workaround: use a modified version of the file in script_utils.php and don't include that file.
