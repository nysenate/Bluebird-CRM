...
INSERT INTO shadow_address (address_id, contact_id, street_address, postal_code, city, country_id, state_province_id, supplemental_address_1, supplemental_address_2)
	SELECT id, contact_id, BB_NORMALIZE_ADDR(street_address), IFNULL(postal_code,''), IFNULL(city,''), country_id, state_province_id, BB_NORMALIZE_ADDR(supplemental_address_1), BB_NORMALIZE_ADDR(supplemental_address_2) FROM civicrm_address;
