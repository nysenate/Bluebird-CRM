    ...
    cj.ajax({
      ...
      success: function(data,status) {
        ...
        if(message.code == 'ERROR'){
          ...
          cj('#message_left_header').append("<br/><span class='popup_def'>Subject: </span>"+shortenString(message.subject,60)+" "+ icon+"<br/><span class='popup_def'>Date Forwarded: </span>"+message.date_long+"<br/>");
    ...
    cj.ajax({
      ...
      success: function(data,status) {
        ...
        if (message.code == 'ERROR'){
          ...
          cj('#message_left_header').append("<br/><span class='popup_def'>Subject: </span>"+shortenString(message.subject,60) +"<br/><span class='popup_def'>Date Forwarded: </span>"+message.date_long+"<br/>");
    ...
    cj.ajax({
      ...
      success: function(data,status) {
        ...
        if(messages.code == 'ERROR'){
          ...
          cj('#message_left_header_tag').html('').append("<span class='popup_def'>From: </span>"+messages.sender_name +"  <span class='emailbubble'>"+ messages.sender_email+"</span><br/><span class='popup_def'>Subject: </span>"+shortenString(messages.subject,60)+"<br/><span class='popup_def'>Date Forwarded: </span>"+messages.date_long+"<br/>");
      ...
      cj.ajax({
        ...
        success: function(data,status) {
          ...
          if(message.code == 'ERROR'){
            ...
            cj('#message_left_tag').append("<div id='header_"+activityId+"' data-id='"+activityId+"' class='message_left_header_tags'><span class='popup_def'>From: </span>"+message.sender_name +"  <span class='emailbubble'>"+ message.sender_email+"</span><br/><span class='popup_def'>Subject: </span>"+shortenString(message.subject,60)+"<br/><span class='popup_def'>Date Forwarded: </span>"+message.date_long+"<br/></div><div id='email_"+activityId+"' class='hidden_email' data-id='"+activityId+"'></div>");
