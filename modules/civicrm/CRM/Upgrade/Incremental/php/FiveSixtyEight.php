...
class CRM_Upgrade_Incremental_php_FiveSixtyEight extends CRM_Upgrade_Incremental_Base {
  ...
  public function upgrade_5_68_alpha1($rev): void {
    ...
    $this->addTask('Add Tag.label field', 'addColumn', 'civicrm_tag', 'label', "varchar(128) NOT NULL COMMENT 'User-facing tag name' AFTER `name`");
    $this->addTask('Update Tag.name field', 'alterColumn', 'civicrm_tag', 'name', "varchar(128) NOT NULL COMMENT 'Unique machine name'");
