...
{literal}
SELECT @svdsearch := max(id) FROM civicrm_saved_search;
SELECT @mappingid := max(id) FROM civicrm_mapping;

INSERT INTO `civicrm_mapping` (`id`, `name`, `description`, `mapping_type_id`) VALUES
(@mappingid + 1, NULL, NULL, NULL);
...
('', @mappingid + 1, 'is_deceased', 'Individual', 0, NULL, NULL, NULL, NULL, NULL, 1, '=', '1', NULL),
('', @mappingid + 1, 'do_not_mail', 'Individual', 0, NULL, NULL, NULL, NULL, NULL, 2, '=', '1', NULL),
('', @mappingid + 1, 'do_not_mail', 'Household', 0, NULL, NULL, NULL, NULL, NULL, 3, '=', '1', NULL),
('', @mappingid + 1, 'do_not_mail', 'Organization', 0, NULL, NULL, NULL, NULL, NULL, 4, '=', '1', NULL);
