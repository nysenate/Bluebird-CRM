      ...
      <table class="form-layout-compressed">
        ...
        {if $geoCode}
         <tr class="crm-import-datasource-form-block-doGeocodeAddress">
             <td></td><td>{$form.doGeocodeAddress.html} {$form.doGeocodeAddress.label}<br />
               <span class="description">
                {ts}This option is not recommended for large imports. Use the command-line geocoding script instead.{/ts} {docURL page="Batch Geocoding Script"}</span>
            </td></tr>
        {/if}
