...
CREATE
   ...
   BEGIN
      ...
      CASE NEW.`log_table_name`
         ...
         WHEN 'log_civicrm_value_organization_constituent_informa_3' THEN SET NEW.`log_type_label`='Contact';
         WHEN 'log_civicrm_value_attachments_5' THEN SET NEW.`log_type_label`='Contact';
