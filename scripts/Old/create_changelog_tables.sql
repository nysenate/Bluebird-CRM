...
CREATE TABLE nyss_changelog_detail (
  summary_id BIGINT(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'unique-per-session value generated for each record',
  ...
  tmp_date_extract INT(10) NOT NULL,
  INDEX tmp_idx__changelog_detail (tmp_conn_id, tmp_user_id, tmp_contact_id, tmp_date_extract),
