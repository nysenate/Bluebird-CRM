...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'aileen'), (@last_id,'ailie'), (@last_id,'allie'), (@last_id,'dan'), (@last_id,'dani'), (@last_id,'danielle'), (@last_id,'danni'), (@last_id,'eileen'), (@last_id,'elaine'), (@last_id,'eleanor'), (@last_id,'eleni'), (@last_id,'ella'), (@last_id,'elle'), (@last_id,'ellen'), (@last_id,'ellie'), (@last_id,'gabby'), (@last_id,'gabriella'), (@last_id,'helen'), (@last_id,'helene'), (@last_id,'lainie'), (@last_id,'lena'), (@last_id,'lu'), (@last_id,'luella'), (@last_id,'lula'), (@last_id,'nell'), (@last_id,'nellie'), (@last_id,'nora'), (@last_id,'norah');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'aggie'), (@last_id,'aggy'), (@last_id,'agnes'), (@last_id,'ann'), (@last_id,'anna'), (@last_id,'anne'), (@last_id,'annette'), (@last_id,'annie'), (@last_id,'inez'), (@last_id,'nan'), (@last_id,'nana'), (@last_id,'nance'), (@last_id,'nancy'), (@last_id,'nannie'), (@last_id,'nanny'), (@last_id,'nessa'), (@last_id,'nessie'), (@last_id,'nettie'), (@last_id,'nina'), (@last_id,'steph'), (@last_id,'stephanie'), (@last_id,'stephen'), (@last_id,'stephie'), (@last_id,'steve'), (@last_id,'steven'), (@last_id,'stevie');
...
INSERT INTO fn_group (given, new) VALUES ('alyssa',0);
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'ally'), (@last_id,'alyssa'), (@last_id,'lyssa');
...
INSERT INTO fn_group (given, new) VALUES ('susan',0);
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'hannah'), (@last_id,'sue'), (@last_id,'sukey'), (@last_id,'susan'), (@last_id,'susanna'), (@last_id,'susie'), (@last_id,'susy'), (@last_id,'suz'), (@last_id,'suzy');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'aileen'), (@last_id,'ailie'), (@last_id,'eileen'), (@last_id,'elaine'), (@last_id,'eleanor'), (@last_id,'ella'), (@last_id,'elle'), (@last_id,'ellen'), (@last_id,'ellender'), (@last_id,'ellie'), (@last_id,'helen'), (@last_id,'helena'), (@last_id,'lanna'), (@last_id,'lee'), (@last_id,'lena'), (@last_id,'lenora'), (@last_id,'nell'), (@last_id,'nellie'), (@last_id,'nelly'), (@last_id,'nora'), (@last_id,'norah');
...
INSERT INTO fn_group (given, new) VALUES ('louis',0);
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'lew'), (@last_id,'lewie'), (@last_id,'lou'), (@last_id,'louie'), (@last_id,'louis');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'caitlin'), (@last_id,'cassie'), (@last_id,'casy'), (@last_id,'cat'), (@last_id,'cate'), (@last_id,'cath'), (@last_id,'catherine'), (@last_id,'cathie'), (@last_id,'cathy'), (@last_id,'catriona'), (@last_id,'karen'), (@last_id,'kate'), (@last_id,'kath'), (@last_id,'katharine'), (@last_id,'kathie'), (@last_id,'kathleen'), (@last_id,'kathy'), (@last_id,'katie'), (@last_id,'katrine'), (@last_id,'katy'), (@last_id,'kay'), (@last_id,'kit'), (@last_id,'kittie'), (@last_id,'kitty'), (@last_id,'lena'), (@last_id,'rena'), (@last_id,'trina');
...
INSERT INTO fn_group (given, new) VALUES ('louisa',0);
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'lou'), (@last_id,'louie'), (@last_id,'louisa');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'ad'), (@last_id,'ade'), (@last_id,'adelbert'), (@last_id,'albert'), (@last_id,'bert'), (@last_id,'del'), (@last_id,'delbert'), (@last_id,'elbert');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'cassie'), (@last_id,'casy'), (@last_id,'cat'), (@last_id,'cathie'), (@last_id,'cathy'), (@last_id,'kat'), (@last_id,'kate'), (@last_id,'katherine'), (@last_id,'kathie'), (@last_id,'kathleen'), (@last_id,'kathy'), (@last_id,'katie'), (@last_id,'katrine'), (@last_id,'katy'), (@last_id,'kay'), (@last_id,'kaye'), (@last_id,'kit'), (@last_id,'kittie'), (@last_id,'kitty'), (@last_id,'lena'), (@last_id,'rina'), (@last_id,'terri'), (@last_id,'trina');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'elouise'), (@last_id,'louise');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'linda'), (@last_id,'lindy'), (@last_id,'mel'), (@last_id,'melinda'), (@last_id,'mindy');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'earnest'), (@last_id,'ernestine'), (@last_id,'ernie');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'bob'), (@last_id,'bobby'), (@last_id,'dob'), (@last_id,'rob'), (@last_id,'robbie'), (@last_id,'robin'), (@last_id,'rupert');
...
SET @last_id:=LAST_INSERT_ID();
INSERT INTO fn_group_name (fn_group_id, name) VALUES
	(@last_id,'sue'), (@last_id,'suki'), (@last_id,'susie'), (@last_id,'suzanne');
