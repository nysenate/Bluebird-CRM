...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT log_action, 'contact' AS log_type, log_user_id, log_date, id AS altered_contact_id,`log_conn_id`
	FROM {{LOGDB}}.log_civicrm_contact 
	WHERE (log_action != 'Initialization');

INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT log_action, 'email' AS log_type, log_user_id, log_date, contact_id AS altered_contact_id,`log_conn_id`
	FROM {{LOGDB}}.log_civicrm_email 
	WHERE (log_action != 'Initialization');

INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT log_action, 'phone' AS log_type, log_user_id, log_date, contact_id AS altered_contact_id,`log_conn_id`
	FROM {{LOGDB}}.log_civicrm_phone 
	WHERE (log_action != 'Initialization');

INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT log_action, 'address' AS log_type, log_user_id, log_date, contact_id AS altered_contact_id,`log_conn_id`
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT log_action, 'group_contact' AS log_type, log_user_id, log_date, contact_id AS altered_contact_id,`log_conn_id`
	FROM {{LOGDB}}.log_civicrm_group_contact 
	WHERE (log_action != 'Initialization');

INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT log_action, 'entity_tag' AS log_type, log_user_id, log_date, entity_id AS altered_contact_id,`log_conn_id`
	FROM {{LOGDB}}.log_civicrm_entity_tag
	WHERE (log_action != 'Initialization') AND (entity_table = 'civicrm_contact');

INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT log_action, 'relationship' AS log_type, log_user_id, log_date, contact_id_a AS altered_contact_id,`log_conn_id`
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	(`log_action`,`log_type`,`log_user_id`,`log_date`,`altered_contact_id`,`log_conn_id`)
	SELECT a.log_action, 'case' AS log_type, a.log_user_id, a.log_date, b.contact_id as altered_contact_id,a.`log_conn_id`
	FROM 
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	...
	SELECT 
		log_action, 
		'value_constituent_information_1' AS log_type, 
		log_user_id, 
		log_date, 
		entity_id AS altered_contact_id,`log_conn_id`
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	...
	SELECT 
		log_action, 
		'value_organization_constituent_informa_3' AS log_type, 
		log_user_id, 
		log_date, 
		entity_id AS altered_contact_id,`log_conn_id`
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	...
	SELECT 
		log_action, 
		'value_attachments_5' AS log_type, 
		log_user_id, 
		log_date, 
		entity_id AS altered_contact_id,`log_conn_id`
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	...
	SELECT 
		log_action, 
		'value_contact_details_8' AS log_type, 
		log_user_id, 
		log_date, 
		entity_id AS altered_contact_id,`log_conn_id`
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	...
	SELECT 
		a.log_action, 
		'value_district_information_7' AS log_type, 
		a.log_user_id, 
		a.log_date, 
		b.contact_id as altered_contact_id,a.`log_conn_id`
	FROM 
...
INSERT IGNORE INTO {{CIVIDB}}.civicrm_changelog_summary 
	...
	SELECT 
		a.log_action, 
		CONCAT('value_activity_details_6_for_',
			case b.record_type_id 
				when 1 then 'target'
				when 2 then 'source'
				when 3 then 'assignee'
