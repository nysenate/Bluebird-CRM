...
(function() {
  var BBTagLabel, View, bbLocalStorage, getTrees, instance, parseTree, tree, treeBehavior, _ref, _ref1, _treeData, _viewSettings,
    __slice = [].slice,
  ...
  treeBehavior = {
    ...
    enableDropdowns: function() {
      ...
      return cj(".JSTree .treeButton").on("click", function() {
        var received, set, tagLabel, tagid,
          _this = this;
        ...
        tagLabel.siblings("dl#tagDropdown_" + tagid).slideToggle("200", function() {
          ...
          if (tagLabel.is(".open")) {
            return _viewSettings["openTags"][tagid] = true;
          } else {
            return _viewSettings["openTags"][tagid] = null;
          }
        });
        received = bbLocalStorage("tagViewSettings");
        return console.dir("received", received);
      });
    }
  };

  bbLocalStorage = function(key, value) {
    if (!localStorage) {
      return false;
    }
    if (value != null) {
