...
(function() {
  var BBTagLabel, Instancd, Node, OpenLeg, Tree, View, getTrees, instance, parseTree, tree, treeBehavior, treeManipulation, utils, _treeData, _treeVisibility, _utils, _viewSettings,
    __slice = [].slice,
  ...
  instance = (function() {
    function instance() {
      this.removeDupFromExtend = __bind(this.removeDupFromExtend, this);
