...
(function() {
  var Action, ActivityLog, Autocomplete, Buttons, Entity, Instance, Label, Node, OpenLeg, Resize, Settings, Tree, View, jstree, setProp, _descWidths, _getTrees, _openTags, _parseAutocomplete, _parseTree, _tree, _treeUtils, _treeVisibility, _utils,
    __slice = [].slice,
    _this = this,
