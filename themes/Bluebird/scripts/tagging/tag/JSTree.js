...
(function() {
  var Action, ActivityLog, Autocomplete, Buttons, Entity, Instance, Label, Node, OpenLeg, Resize, Settings, Token, Tree, View, jstree, setProp, _descWidths, _getTrees, _manipTags, _openTags, _parseAutocomplete, _parseTree, _tree, _treeUtils, _treeVisibility, _utils,
    __slice = [].slice,
    _this = this,
  ...
  _parseAutocomplete = {
    pre: function(obj) {
      ...
      if (obj.name === "Inbox Polling Unprocessed") {
        return true;
      }
      hasChildren = false;
