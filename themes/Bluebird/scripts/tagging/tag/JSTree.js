...
(function() {
  var Action, Autocomplete, Buttons, Instance, Node, OpenLeg, Resize, Settings, Tree, View, jstree, setProp, _descWidths, _getTrees, _openTags, _parseAutocomplete, _parseTree, _tree, _treeUtils, _treeVisibility, _utils,
    __slice = [].slice,
    _this = this,
  ...
  View = (function() {
    ...
    View.prototype.init = function() {
      ...
      return buttons = new Buttons(this);
    };
  ...
  Buttons = (function() {
    ...
    function Buttons(view) {
      ...
      for (k in _ref) {
        ...
        cjTreeTop.on("mouseleave", function(tag) {
          var cjDT;
  ...
  Node = (function() {
    ...
    Node.prototype.html = function(node) {
      ...
      html += "              </div>              <div class='transparancyBox type-" + node.type + "'></div>              </dt>            ";
