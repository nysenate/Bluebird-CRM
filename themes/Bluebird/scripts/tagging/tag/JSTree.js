...
(function() {
  var Action, Autocomplete, Buttons, Entity, Instance, Node, OpenLeg, Resize, Settings, Tree, View, jstree, setProp, _descWidths, _getTrees, _openTags, _parseAutocomplete, _parseTree, _tree, _treeUtils, _treeVisibility, _utils,
    __slice = [].slice,
    _this = this,
  ...
  Instance = (function() {
    ...
    Instance.prototype.getEntity = function(entityId, cb) {
      ...
      return new Entity(entityId, function(tags) {
