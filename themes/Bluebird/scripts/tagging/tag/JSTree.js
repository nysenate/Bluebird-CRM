...
(function() {
  var Autocomplete, Instance, Node, OpenLeg, Resize, Settings, Tree, View, jstree, setProp, _descWidths, _filtered, _getTrees, _length, _openTags, _parseAutocomplete, _parseTree, _tree, _treeUtils, _treeVisibility, _utils,
    __slice = [].slice,
    _this = this,
  ...
  View = (function() {
    ...
    View.prototype.writeFilteredList = function(list, term, hits) {
      ...
      console.log(this.shouldBeFiltered);
      console.log(hits);
      console.log(term);
      console.log(this.currentWrittenTerm);
      if (this.currentWrittenTerm.length === 0) {
        this.currentWrittenTerm = term;
      }
      if (this.currentWrittenTerm !== term) {
        console.log("not equal");
        if (term.length > 0) {
          if (term.match(this.currentWrittenTerm) != null) {
            console.log("matched");
            this.currentWrittenTerm = term;
          }
          if (term.length < this.currentWrittenTerm.length) {
            console.log("shorter");
            this.currentWrittenTerm = term;
          } else {
            console.log("not matched");
          }
          return this.currentWrittenTerm = "";
        }
      }
    };
