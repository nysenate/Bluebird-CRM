...
(function() {
  var Action, ActivityLog, Autocomplete, Buttons, Entity, Instance, Node, OpenLeg, Resize, Settings, Tree, View, jstree, setProp, _descWidths, _getTrees, _openTags, _parseAutocomplete, _parseTree, _tree, _treeUtils, _treeVisibility, _utils,
    __slice = [].slice,
    _this = this,
  ...
  View = (function() {
    ...
    View.prototype.setTaggingOrEdit = function() {
      ...
      if (this.settings.tagging) {
        ...
        return this.applyTagged(this.entity_id);
      }
    };
