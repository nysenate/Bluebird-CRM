                            ...
                            <div class="crm-section tag-section contact-tagset-296-section crm-processed-input">
                                ...
                                <div class="content">
                                    ...
                                    <ul class="token-input-list-facebook">
                                        <li class="token-input-input-token-facebook token-input-highlighted-token-facebook">
                                            <input type="text" autocomplete="off" maxlength="64" id="token-input-contact_taglist_296" style="outline: none; width: 30px;">
                                    ...
                                    <input type="hidden" name="contact_taglist[296]" value="" id="contact_taglist_296" class="contact-taglist_296" style="display: none;">
                                </div>
                                <div class="clear"></div>
                            </div>
                                ...
                                <div class="content">
                                    ...
                                    <ul class="token-input-list-facebook">
                                        <li class="token-input-input-token-facebook">
                                            <input type="text" autocomplete="off" maxlength="64" id="token-input-contact_taglist_292" style="outline: none;">
                                            <tester style="position: absolute; top: -9999px; left: -9999px; width: auto; font-size: 12px; font-family: Verdana, Arial, sans-serif; font-weight: 400; letter-spacing: 0px; white-space: nowrap;"></tester>
                                        </li>
                                    </ul>
                                    <input type="hidden" name="contact_taglist[292]" value="" id="contact_taglist_292" class="contact-taglist_292" style="display: none;">
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
