...
function callTagListMain(treeLoc, treeData, pointToTab) {
	...
	if(tID.children.length > 0){
		...
		cj.each(tID.children, function(i, cID){
			...
			displayObj.output += '<dt class="lv-'+displayObj.tLvl+' issueCode-'+cID.id+''+cIDChecked+' '+isItemReserved(cID.is_reserved,cID.id)+'" id="tagLabel_'+cID.id+'" description="'+escapePositions(cID.description, tID.id)+'" tID="'+cID.id+'"><div class="'+isItemChildless(cID.children.length)+'"></div><div class="tag"><span class="name">'+cID.name+'</span><span 


class="entityCount" style="display:none;">('+cID.entity_count+')</span></div>';
			...
			if(cID.children.length > 0){
				...
				cj.each(cID.children, function(i, iID){
					...
					displayObj.output += '<dt class="lv-'+displayObj.tLvl+' issueCode-'+iID.id+''+iIDChecked+' '+isItemReserved(iID.is_reserved,iID.id)+'" id="tagLabel_'+iID.id+'" description="'+escapePositions(iID.description, tID.id)+'" tID="'+iID.id+'"><div class="'+isItemChildless(iID.children.length)+'"></div><div class="tag"><span class="name">'+iID.name+'</span><span 


class="entityCount" style="display:none;">('+iID.entity_count+')</span></div>';
					...
					if(iID.children.length > 0){
						...
						cj.each(iID.children, function(i, jID){
							...
							displayObj.output += '<dt class="lv-'+displayObj.tLvl+' issueCode-'+jID.id+''+jIDChecked+' '+isItemReserved(jID.is_reserved,jID.id)+'" id="tagLabel_'+jID.id+'" description="'+escapePositions(jID.description, tID.id)+'" tID="'+jID.id+'"><div class="'+isItemChildless(jID.children.length)+'"></div><div class="tag"><span class="name">'+jID.name+'</span><span 


class="entityCount" style="display:none;">('+jID.entity_count+')</span></div>';
							...
							if(jID.children.length > 0){
								...
								cj.each(jID.children, function(i, kID){
									...
									displayObj.output += '<dt class="lv-'+displayObj.tLvl+' issueCode-'+kID.id+''+kIDChecked+' '+isItemReserved(kID.is_reserved,kID.id)+'" id="tagLabel_'+kID.id+'" description="'+escapePositions(kID.description, tID.id)+'" tID="'+kID.id+'"><div class="'+isItemChildless(kID.children.length)+'"></div><div class="tag"><span class="name">'+kID.name+'</span><span 


class="entityCount" style="display:none;">('+kID.entity_count+')</span></div>';
