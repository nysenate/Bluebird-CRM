<?php /* Smarty version 2.6.26, created on 2010-05-26 17:42:34
         compiled from CRM/common/Tag.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/common/Tag.tpl', 21, false),array('function', 'crmURL', 'CRM/common/Tag.tpl', 29, false),)), $this); ?>
...
<div class="section tag-section tag-<?php echo $this->_tpl_vars['tagset']['parentID']; ?>
-section">
<div class="label">
...
<?php else: ?>
    <?php if ($this->_tpl_vars['tagset']['entityTags']): ?>
        <?php $_from = $this->_tpl_vars['tagset']['entityTags']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
