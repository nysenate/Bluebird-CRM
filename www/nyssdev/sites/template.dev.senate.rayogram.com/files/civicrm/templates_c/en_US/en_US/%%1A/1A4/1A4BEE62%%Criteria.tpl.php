<?php /* Smarty version 2.6.26, created on 2010-05-26 18:04:51
...
:</td></tr><?php endif; ?>
                <tr class="crm-report crm-report-field crm-report-field_<?php echo $this->_tpl_vars['dnc']; ?>
">
...
?>
                        ...
                        <?php if (!($this->_tpl_vars['count'] % 4)): ?>
                            </tr><tr class="crm-report crm-report-field crm-report-field_<?php echo $this->_tpl_vars['dnc']; ?>
">
                        <?php endif; ?>
...
?>
	        ...
	        <?php if ($this->_tpl_vars['colGroups'][$this->_tpl_vars['tableName']]['group_title'] && $this->_tpl_vars['filterCount'] >= 1): ?></table><table class="report-layout"><tr class="crm-report crm-report-filter crm-report-filter_<?php echo $this->_tpl_vars['tableName']; ?>
...
?>
                    ...
                    <?php if ($this->_tpl_vars['field']['operatorType'] & 4): ?>
                        <tr class="report-contents crm-report crm-report-filter crm-report-filter_<?php echo $this->_tpl_vars['tableName']; ?>
">
