...
<br />
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['form']['name']['html']): ?>               <tr class="crm-admin-form-block-name">
...
<br />
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['form']['filter']['html']): ?>               <tr class="crm-admin-form-block-filter">
...
<br />
        ...
        <?php if ($this->_tpl_vars['form']['component_id']['html']): ?>               <tr class="crm-admin-form-block-component_id"> 
        ...
        <?php endif; ?>
        <?php if ($this->_tpl_vars['showContactFilter']): ?>           <tr class="crm-admin-form-block-contactOptions"> 
