<?php /* Smarty version 2.6.26, created on 2010-06-11 14:09:33
         compiled from CRM/Contact/Form/Edit/Address/CustomField.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Form/Edit/Address/CustomField.tpl', 58, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['element']['is_view'] == 0): ?>    <?php if ($this->_tpl_vars['element']['help_pre']): ?>
    ...
    <?php endif; ?>
     <?php if ($this->_tpl_vars['element']['options_per_line'] != 0): ?>
        <tr>
            <td class="label"><?php echo $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']][$this->_tpl_vars['element_name']]['label']; ?>
</td>
            <td class="html-adjust">
                ...
                <table class="form-layout-compressed" style="margin-top: -0.5em;">
                    <tr>
                        ...
                        <?php $_from = $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']][$this->_tpl_vars['element_name']]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['outer'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                            ...
                            <?php else: ?>
                                <td class="labels font-light"><?php echo $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']][$this->_tpl_vars['element_name']][$this->_tpl_vars['key']]['html']; ?>
</td>
        ...
        <tr>
            ...
            <td class="html-adjust">
                <?php if ($this->_tpl_vars['element']['data_type'] != 'Date'): ?>
                    <?php echo $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']][$this->_tpl_vars['element_name']]['html']; ?>
&nbsp;
...
unset($_smarty_tpl_vars);
 ?>
                ...
                <?php if ($this->_tpl_vars['element']['html_type'] == 'Radio'): ?>
                    <span class="crm-clear-link">(<a href="#" title="unselect" onclick="unselectRadio('address[<?php echo $this->_tpl_vars['blockId']; ?>
][<?php echo $this->_tpl_vars['element_name']; ?>
]', '<?php echo $this->_tpl_vars['form']['formName']; ?>
