<?php /* Smarty version 2.6.26, created on 2010-06-10 16:26:40
...
?><?php echo '<div class="crm-accordion-wrapper crm-ajax-accordion crm-'; ?><?php echo $this->_tpl_vars['paneValue']['id']; ?><?php echo '-accordion '; ?><?php if ($this->_tpl_vars['paneValue']['open'] == 'true'): ?><?php echo 'crm-accordion-open'; ?><?php else: ?><?php echo 'crm-accordion-closed'; ?><?php endif; ?><?php echo '"><div class="crm-accordion-header" id="'; ?><?php echo $this->_tpl_vars['paneValue']['id']; ?><?php echo '"><div class="icon crm-accordion-pointer"></div>'; ?><?php echo $this->_tpl_vars['paneName']; ?><?php echo '</div><div class="crm-accordion-body '; ?><?php echo $this->_tpl_vars['paneValue']['id']; ?><?php echo '"></div></div>'; ?><?php endforeach; endif; unset($_from); ?><?php echo '<div class="spacer"></div><table class="form-layout"><tr><td>'; ?><?php echo $this->_tpl_vars['form']['buttons']['html']; ?><?php echo '  '; ?><?php if ($this->_tpl_vars['form']['deleted_contacts']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['form']['deleted_contacts']['html']; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['form']['deleted_contacts']['label']; ?><?php echo ''; ?><?php endif; ?><?php echo '</td></tr></table>'; ?>
