<?php /* Smarty version 2.6.26, created on 2010-05-28 16:21:01
         compiled from CRM/Import/Form/DataSource.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Import/Form/DataSource.tpl', 27, false),array('function', 'help', 'CRM/Import/Form/DataSource.tpl', 27, false),array('function', 'docURL', 'CRM/Import/Form/DataSource.tpl', 76, false),array('function', 'crmURL', 'CRM/Import/Form/DataSource.tpl', 104, false),)), $this); ?>
  <div id="help">
      <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>The Import Wizard allows you to easily import contact records from other applications into CiviCRM. For example, if your organization has contacts in MS Access&copy; or Excel&copy;, and you want to start using CiviCRM to store these contacts, you can 'import' them here.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> <?php echo smarty_function_help(array('id' => 'choose-data-source-intro'), $this);?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php if ($this->_tpl_vars['geoCode']): ?>
          <dt>&nbsp;</dt><dd><?php echo $this->_tpl_vars['form']['doGeocodeAddress']['html']; ?>
