<?php /* Smarty version 2.6.26, created on 2010-08-19 12:26:58
         compiled from CRM/Contact/Form/Task/AddToTag.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Form/Task/AddToTag.tpl', 28, false),array('function', 'cycle', 'CRM/Contact/Form/Task/AddToTag.tpl', 36, false),)), $this); ?>
<div class="crm-form-block crm-block crm-contact-task-addtotag-form-block">
<h3>
<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Tag Contact(s)<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
</h3>
