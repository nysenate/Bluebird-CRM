<?php /* Smarty version 2.6.26, created on 2010-08-20 09:21:48
         compiled from CRM/Admin/Page/DedupeRules.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Admin/Page/DedupeRules.tpl', 32, false),array('function', 'help', 'CRM/Admin/Page/DedupeRules.tpl', 32, false),array('function', 'cycle', 'CRM/Admin/Page/DedupeRules.tpl', 49, false),)), $this); ?>
<?php if ($this->_tpl_vars['action'] == 1 || $this->_tpl_vars['action'] == 2): ?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CRM/Admin/Form/DedupeRules.tpl", 'smarty_include_vars' => array()));
...
?><?php echo '<tr class="'; ?><?php echo smarty_function_cycle(array('values' => "odd-row,even-row"), $this);?><?php echo '"><td>'; ?><?php if (isset ( $this->_tpl_vars['row']['name'] )): ?><?php echo ''; ?><?php echo $this->_tpl_vars['row']['name']; ?><?php echo ''; ?><?php endif; ?><?php echo '</td><td>'; ?><?php echo $this->_tpl_vars['row']['contact_type_display']; ?><?php echo '</td><td>'; ?><?php echo $this->_tpl_vars['row']['level']; ?><?php echo '</td>'; ?><?php if ($this->_tpl_vars['row']['is_default']): ?><?php echo '<td><img src="'; ?><?php echo $this->_tpl_vars['config']->resourceBase; ?><?php echo '/i/check.gif" alt="'; ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo 'Default'; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '" /></td>'; ?><?php else: ?><?php echo '<td></td>'; ?><?php endif; ?><?php echo '<td>'; ?><?php echo ''; ?><?php echo '<a href="/nyss/civicrm/admin/dedupefind?reset=1&rgid='; ?><?php echo $this->_tpl_vars['row']['id']; ?><?php echo '&action=preview">Run Dedupe Rule</a></td></tr>'; ?><?php endforeach; endif; unset($_from); ?><?php echo '</table>'; ?>
