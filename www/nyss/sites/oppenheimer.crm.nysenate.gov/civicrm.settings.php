 ...
 */
define( 'CIVICRM_UF_DSN'           , 'mysql://loadsenate:char12tree*!@cividb01/senate_d_oppenheimer?new_link=true' );
 ...
 *
 */
define( 'CIVICRM_DSN'           , 'mysql://loadsenate:char12tree*!@cividb01/senate_c_oppenheimer?new_link=true' );
...
$civicrm_root = '/data/www/nyss/sites/all/modules/civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/data/www/nyss/sites/oppenheimer.crm.nysenate.gov/files/civicrm/templates_c' );
 ...
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://oppenheimer.crm.nysenate.gov/nyss' );
