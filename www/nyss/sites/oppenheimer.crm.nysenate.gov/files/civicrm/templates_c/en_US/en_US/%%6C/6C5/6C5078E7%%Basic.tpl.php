<?php /* Smarty version 2.6.26, created on 2010-08-25 10:42:49
         compiled from CRM/Contact/Form/Search/Criteria/Basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Form/Search/Criteria/Basic.tpl', 34, false),array('function', 'help', 'CRM/Contact/Form/Search/Criteria/Basic.tpl', 82, false),array('modifier', 'replace', 'CRM/Contact/Form/Search/Criteria/Basic.tpl', 123, false),)), $this); ?>
...
<tr>
    ...
    <label><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Issue Codes<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></label>
    ...
    <td>
    <div style="display:block;"><?php echo $this->_tpl_vars['form']['buttons']['html']; ?>
