 ...
 */
define( 'CIVICRM_UF_DSN'           , 'mysql://%%DBUSR%%:%%DBPWD%%@%%DBHOST%%/%%DBDRUPAL%%?new_link=true' );
 ...
 *
 */
define( 'CIVICRM_DSN'           , 'mysql://%%DBUSR%%:%%DBPWD%%@%%DBHOST%%/%%DBCIVI%%?new_link=true' );
...
$civicrm_root = '%%ROOTDIR%%sites/all/modules/civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '%%ROOTDIR%%sites/%%URL%%/files/civicrm/templates_c' );
 ...
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://%%URL%%/nyss' );
