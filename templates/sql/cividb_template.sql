...
INSERT INTO `civicrm_address` VALUES (4,NULL,1,0,0,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1031,NULL,NULL,NULL,1228,40.7143528,-74.0059731,NULL,NULL,NULL);
...
CREATE TABLE `civicrm_contact` (
  ...
  KEY `individualStrict1` (`first_name`,`middle_name`,`last_name`,`suffix_id`),
...
INSERT INTO `civicrm_dashboard` VALUES (1,1,'Activities','civicrm/dashlet/activity&reset=1&snippet=4',NULL,'access CiviCRM',NULL,0,0,1,1,1,1,'2011-07-08 12:00:45'),(2,1,'My Cases','civicrm/dashlet/myCases&reset=1&snippet=4',NULL,'access my cases and activities',NULL,0,0,1,1,1,1,'2011-07-08 12:00:45'),(3,1,'All Cases','civicrm/dashlet/allCases&reset=1&snippet=4',NULL,'access all cases and activities',NULL,0,0,1,1,1,1,'2011-07-08 12:00:45'),(4,1,'Twitter','civicrm/dashlet/twitter&reset=1&snippet=4',NULL,'access CiviCRM',NULL,0,0,0,1,1,1,'2011-07-08 12:00:44'),(5,1,'All Activities, Last 7 Days','civicrm/report/instance/23&reset=1&section=2&snippet=4',NULL,'access all cases and activities',NULL,0,0,1,1,1,0,'2011-07-08 12:00:45'),(6,1,'Emails Received, Last 7 Days','civicrm/report/instance/24&reset=1&section=2&snippet=4',NULL,'access all cases and activities',NULL,0,0,1,1,1,0,'2011-07-08 12:00:45');
...
INSERT INTO `civicrm_dedupe_rule_group` VALUES (1,'Individual',5,'Fuzzy',1,'Level 3 (street + lname + fname + city + suffix)'),(2,'Organization',10,'Fuzzy',1,'Level 2 (name + street + city + zip)'),(3,'Household',30,'Fuzzy',1,'Level 2 (name + street + zip)'),(4,'Individual',5,'Strict',1,'Level 1 (fname + mname + lname + suffix + street + postal)'),(5,'Organization',40,'Strict',1,'Level 1 (name + address + city + email)'),(6,'Household',40,'Strict',1,'Level 1 (name + street + city + email)'),(7,'Household',30,'Fuzzy',0,'Level 3 (name + street + city)'),(8,'Individual',16,'Strict',0,'Level 2 (fname + lname + city + birth)'),(9,'Individual',30,'Fuzzy',0,'Level 4 (fname + lname + email)'),(10,'Organization',6,'Fuzzy',0,'Level 3 (name + street + city)');
